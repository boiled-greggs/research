...
path = [ [0., 0., 0.], [0., 0.5, 0.], [0.25, 0.25, 0.], [.25, .25, .25], [0., 0., 0.], [0.25, 0.25, 0.] ]
...
# fig.tight_layout()
fig.savefig('bccP8-0-1.eps')


k_vecs = my_model.k_uniform_mesh([30,30,30])
"""
kmesh = 100
kpts = []
...
"""
evals=my_model.solve_all(k_vecs)
